// Build the Iron Jarvis browser add-on: three TypeScript entry points plus the
...
/** Output name -> entry point, one per surface. `content` joins this in Ship 2.
 *
...
async function main() {
  ...
  console.log("built dist/background.js, dist/popup.js, dist/setup.js + 2 html");
}
