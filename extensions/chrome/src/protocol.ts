...
export const ALL_PANEL_ACTIONS = ["open", "send", "stop", "steer", "approve", "deny", "close", "voice"] as const;
export const ALL_PANEL_EVENTS = ["state", "delta", "tool", "approval", "steered", "done", "error", "models", "transcript"] as const;
