...
export const ALL_PANEL_ACTIONS = ["open", "send", "stop", "steer", "approve", "deny", "close", "voice", "reset", "auto_allow"] as const;
export const ALL_PANEL_EVENTS = ["state", "delta", "tool", "approval", "steered", "done", "error", "models", "transcript", "history"] as const;
...
export const PANEL_EVENT_HISTORY = "history";
export const PANEL_EVENT_MODELS = "models";
export const PANEL_EVENT_STATE = "state";
export const PANEL_EVENT_STEERED = "steered";
export const PANEL_EVENT_TOOL = "tool";
export const PANEL_EVENT_TRANSCRIPT = "transcript";
