...
vi.mock("@/lib/useChatStream", () => ({
  ...
  // v1.250.0 (S-03) made the composer read streamed text through `useLiveText`,
  // so EVERY mock of this module must export it or the component throws
  // "No 'useLiveText' export is defined on the mock" — the contract that broke
  // 264 tests when it was first missed. This file arrived from a branch cut
  // before that rule.
