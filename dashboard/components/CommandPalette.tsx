...
const COMMANDS: Command[] = [
  ...
  { id: "activity", label: "Activity", hint: "Work", icon: History, href: "/activity", keywords: "audit undo time travel timeline events trust export" },
  ...
  { id: "artifacts", label: "Artifacts", hint: "Code", icon: Code2, href: "/artifacts", keywords: "code scripts run_code re-run mini apps python powershell bash" },
  { id: "connections", label: "Connections", hint: "Connections", icon: PlugZap, href: "/connections", keywords: "models providers api key integrations rest hookup connect accounts oauth" },
